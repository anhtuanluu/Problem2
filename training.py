...
#DataSet
#Phải chuyển Lable thành relate và unrelate, cột Text sẽ chứa câu của người dùng, cột Text1 sẽ chứa tên khía cạnh
...
#Tạo dataloader
# ở đây data_train là file csv với định dạng như đã định nghĩa bên dataset trên, thiết lập chiều dài tối đa là 160, có thể set dài hơn nhưng nên dựa vào thống kê dữ liệu, có thể set batch_size lớn hơn nếu đủ vram
print("Reading training data...")
train_set = CustomDataset(data=data_train, maxlen=160, tokenizer=tokenizer)
print("Reading validation data...")
val_set = CustomDataset(data=data_val, maxlen=160, tokenizer=tokenizer)
# Creating instances of training and validation dataloaders
train_loader = DataLoader(train_set, batch_size=16)
val_loader = DataLoader(val_set, batch_size=16)

#Model basic nhất với 2 đầu ra relate và unrelate, sẽ thử với model này trước 
